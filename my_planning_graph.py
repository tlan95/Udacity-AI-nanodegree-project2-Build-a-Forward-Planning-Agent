...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        return any([~eff in actionA.effects for eff in actionB.effects] + [~eff in actionB.effects for eff in actionA.effects])
    ...
    def _interference(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        return any([~eff in actionA.preconditions for eff in actionB.effects]) \
                or any([~eff in actionB.preconditions for eff in actionA.effects])
...
class PlanningGraph:
    ...
    def h_setlevel(self):
        ...
        while not self._is_leveled:
            ...
            if AllGoalsMet(layer) and GoalsNoMutex(layer):
                return level
